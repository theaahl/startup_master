...
if('user_id' not in st.session_state):
    ...
    st.subheader("Task")
    st.write("In this user test, your task is to act as your role in your own startup and ask the chatbots questions you would consider natural for an early-stage startup to have regarding idea validation and early prototype development. \n \n Test out **all** the chatbots (Chatbot 1, Chatbot 2 and Chatbot 3), then answer the questionnaire. Ask all chatbots the **same initial question**, then let the conversation flow naturally for each chatbot.")
