...
if('user_id' not in st.session_state):
    ...
    st.subheader("Task")
    st.write("In this user test, your task is to ask the chatbots questions about idea validation and MVP (Minimum Viable Product) development that an early-stage startup would typically have. Formulate the questions based on your own startup in its early stages.\n \n Test out **all** the chatbots (Chatbot 1, Chatbot 2 and Chatbot 3), then answer the questionnaire. Ask all chatbots the **same initial question**, then let the conversation flow naturally for each chatbot.")
